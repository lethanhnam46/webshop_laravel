                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +84 37 608 6760</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> lethanhnam46@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-sm-6">
                                    <h1><span>BK</span>-SHOP</h1>
                                    <h2>Uy Tín</h2>
                                    <p>Bảo mật thông tin khi thanh toán. </p>
                            ...
                            <div class="item">
                                <div class="col-sm-6">
                                    <h1><span>BK</span>-SHOP</h1>
                                    <h2>Tiện Lợi</h2>
                                    <p>Đơn giản hơn cách mua hàng. </p>
                                    <button type="button" class="btn btn-default get">Đặt hàng ngay</button>
                                </div>
                                <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            <h2><span>bk</span>-shop</h2>
                            <p>Mang cả thế giới vào nhà của bạn.</p>
                        </div>
                    </div>
                    <div class="col-sm-7">
                        <div class="col-sm-3">
